...
const {getAllEvents} = require('../controller/event/getAllEvent.controller.js');
...
const {deleteEvent} = require('../controller/event/deleteevent.controller.js');
const {createTicket} = require('../controller/ticket/createticket.controller.js');
const {getTicket} = require('../controller/ticket/getticket.controller.js');
const {getAllTicket} = require('../controller/ticket/getallticket.controller.js');
const {deleteTicket} = require('../controller/ticket/deleteticket.controller.js');
const {registerForEvent} = require('../controller/event/registerevent.controller.js');
